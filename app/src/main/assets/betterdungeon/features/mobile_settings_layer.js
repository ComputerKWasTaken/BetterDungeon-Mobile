...
<svg width="20" height="20" viewBox="0 0 24 24" fill="url(#bd-gradient-cog)" xmlns="http://www.w3.org/2000/svg" style="filter: drop-shadow(0 0 3px var(--bd-accent-primary));">
  <defs>
